...
@Slf4j @RestController @RequestMapping("/sys/actuator/redis") public class ActuatorRedisController {
     ...
     * @throws Exception
     */
    @GetMapping("/info") public Result<?> getRedisInfo() throws Exception {
     ...
     * @throws Exception
     */
    @GetMapping("/keysSizeForReport") public Map<String, JSONArray> getKeysSizeReport() throws Exception {
     ...
     * @throws Exception
     */
    @GetMapping("/memoryForReport") public Map<String, JSONArray> memoryForReport() throws Exception {
     ...
     * @throws Exception
     */
    @GetMapping("/infoForReport") public Map<String, JSONArray> infoForReport() throws Exception {
     ...
     * @功能：获取磁盘信息
     */
    @GetMapping("/queryDiskInfo") public Result<List<Map<String, Object>>> queryDiskInfo(HttpServletRequest request,
