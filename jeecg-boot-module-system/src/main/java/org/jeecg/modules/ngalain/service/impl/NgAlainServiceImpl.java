...
@Service("ngAlainService") public class NgAlainServiceImpl implements NgAlainService {
    @Autowired private ISysPermissionService sysPermissionService;
    @Autowired private SysDictMapper mapper;

    @Override public JSONArray getMenu(String id) throws Exception {
        return getJeecgMenu(id);
    }

    @Override public JSONArray getJeecgMenu(String id) throws Exception {
    ...
    @Override public List<Map<String, String>> getDictByTable(String table, String key, String value) {
    ...
    private void getPermissionJsonArray(JSONArray jsonArray, List<SysPermission> metaList, JSONObject parentJson) {
        for (SysPermission permission : metaList) {
            ...
            } else if (parentJson != null && oConvertUtils.isNotEmpty(tempPid) && tempPid
                .equals(parentJson.getString("id"))) {
    ...
    private JSONObject getPermissionJsonObject(SysPermission permission) {
        ...
        if (permission.getMenuType() == 2) {
            ...
            if (permission.getUrl() != null && (permission.getUrl().startsWith("http://") || permission.getUrl()
                .startsWith("https://"))) {
