 ...
 * @Version: V1.0
 */
@Service public class SysCheckRuleServiceImpl extends ServiceImpl<SysCheckRuleMapper, SysCheckRule>
    ...
    @Override public SysCheckRule getByCode(String ruleCode) {
     ...
     */
    @Override public JSONObject checkValue(SysCheckRule checkRule, String value) {
