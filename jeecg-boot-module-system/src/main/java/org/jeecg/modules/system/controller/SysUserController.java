 ...
 * @since 2018-12-20
 */
@Api(tags = "JEECG-系统用户管理") @Slf4j @RestController @RequestMapping("/sys/user") public class SysUserController {
    ...
    @Autowired private ISysDepartRoleUserService departRoleUserService;
    @Autowired private ISysDepartRoleService departRoleService;
     ...
     * @return
     */
    @PermissionData(pageComponent = "system/UserList") @GetMapping(value = "/list")
    ...
    @PostMapping(value = "/add") public Result<SysUser> add(@RequestBody JSONObject jsonObject) {
    ...
    @PostMapping(value = "/edit") public Result<SysUser> edit(@RequestBody JSONObject jsonObject) {
        Result<SysUser> result = new Result<>();
        try {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/frozenBatch") public Result<SysUser> frozenBatch(@RequestBody JSONObject jsonObject) {
        Result<SysUser> result = new Result<>();
        try {
    ...
    @GetMapping(value = "/queryById") public Result<SysUser> queryById(@RequestParam(name = "id") String id) {
        Result<SysUser> result = new Result<>();
    ...
    public Result<List<String>> queryUserRole(@RequestParam(name = "userid") String userid) {
        ...
        List<SysUserRole> userRole =
            sysUserRoleService.list(new QueryWrapper<SysUserRole>().lambda().eq(SysUserRole::getUserId, userid));
    ...
    /**
     * 校验用户账号是否唯一<br> 可以校验其他 需要检验什么就传什么。。。
     *
     * @param sysUser
     * @return
     */
    @GetMapping(value = "/checkOnlyUser") public Result<Boolean> checkOnlyUser(SysUser sysUser) {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/changePassword") public Result<?> changePassword(@RequestBody SysUser sysUser) {
        SysUser u = this.sysUserService.getOne(
     ...
     * @return
     */
    @GetMapping(value = "/userDepartList") public Result<List<DepartIdModel>> getUserDepartsList(
     ...
     * @return
     */
    @GetMapping(value = "/generateUserId") public Result<String> generateUserId() {
     ...
     * @return
     */
    @GetMapping(value = "/queryUserByDepId") public Result<List<SysUser>> queryUserByDepId(
        @RequestParam(name = "id") String id, @RequestParam(name = "realname", required = false) String realname) {
     ...
     * @return
     */
    @GetMapping(value = "/queryUserComponentData") public Result<IPage<SysUser>> queryUserComponentData(
        @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
        ...
        IPage<SysUser> pageList =
            sysUserDepartService.queryDepartUserPageList(departId, username, realname, pageSize, pageNo);
     ...
     * @param sysUser
     */
    @RequestMapping(value = "/exportXls") public ModelAndView exportXls(SysUser sysUser, HttpServletRequest request) {
        // Step.1 组装查询条件
    ...
    @PostMapping(value = "/importExcel") public Result<?> importExcel(HttpServletRequest request,
            ...
            try {
                ...
                for (int i = 0; i < listSysUsers.size(); i++) {
                    ...
                    String passwordEncode =
                        PasswordUtil.encrypt(sysUserExcel.getUsername(), sysUserExcel.getPassword(), salt);
     ...
     * @功能：根据id 批量查询
     */
    @GetMapping(value = "/queryByIds") public Result<Collection<SysUser>> queryByIds(@RequestParam String userIds) {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/updatePassword") public Result<?> updatePassword(@RequestBody JSONObject json) {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/addSysUserRole") public Result<String> addSysUserRole(
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteUserRole") public Result<SysUserRole> deleteUserRole(
        @RequestParam(name = "roleId") String roleId, @RequestParam(name = "userId") String userId) {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteUserRoleBatch") public Result<SysUserRole> deleteUserRoleBatch(
        @RequestParam(name = "roleId") String roleId, @RequestParam(name = "userIds") String userIds) {
     ...
     * 部门用户列表
     */
    @GetMapping(value = "/departUserList") public Result<IPage<SysUser>> departUserList(
        @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
        @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize, HttpServletRequest req) {
        Result<IPage<SysUser>> result = new Result<>();
        Page<SysUser> page = new Page<>(pageNo, pageSize);
     ...
     */
    @GetMapping("/queryByOrgCode") public Result<?> queryByDepartId(
        @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
        @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
        @RequestParam(name = "orgCode") String orgCode, SysUser userParams) {
        IPage<SysUserSysDepartModel> pageList =
            sysUserService.queryUserByOrgCode(orgCode, userParams, new Page(pageNo, pageSize));
        return Result.OK(pageList);
    }
     ...
     */
    @GetMapping("/queryByOrgCodeForAddressList") public Result<?> queryByOrgCodeForAddressList(
        @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
        @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/editSysDepartWithUser") public Result<String> editSysDepartWithUser(
        @RequestBody SysDepartUsersVO sysDepartUsersVO) {
        Result<String> result = new Result<>();
        try {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteUserInDepart") public Result<SysUserDepart> deleteUserInDepart(
        @RequestParam(name = "depId") String depId, @RequestParam(name = "userId") String userId) {
        ...
        try {
            ...
            if (b) {
                List<SysDepartRole> sysDepartRoleList =
                    departRoleService.list(new QueryWrapper<SysDepartRole>().eq("depart_id", depId));
                List<String> roleIds =
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteUserInDepartBatch") public Result<SysUserDepart> deleteUserInDepartBatch(
        @RequestParam(name = "depId") String depId, @RequestParam(name = "userIds") String userIds) {
        Result<SysUserDepart> result = new Result<>();
        try {
            QueryWrapper<SysUserDepart> queryWrapper = new QueryWrapper<>();
     ...
     * @return
     */
    @GetMapping(value = "/getCurrentUserDeparts") public Result<Map<String, Object>> getCurrentUserDeparts() {
     ...
     * @return
     */
    @PostMapping("/register") public Result<JSONObject> userRegister(@RequestBody JSONObject jsonObject, SysUser user) {
     ...
     * 用户手机号验证
     */
    @PostMapping("/phoneVerification") public Result<Map<String, String>> phoneVerification(
     ...
     * 用户更改密码
     */
    @GetMapping("/passwordChange") public Result<SysUser> passwordChange(
        @RequestParam(name = "username") String username, @RequestParam(name = "password") String password,
        @RequestParam(name = "smscode") String smscode, @RequestParam(name = "phone") String phone) {
        Result<SysUser> result = new Result<>();
        if (oConvertUtils.isEmpty(username) || oConvertUtils.isEmpty(password) || oConvertUtils.isEmpty(
            smscode) || oConvertUtils.isEmpty(phone)) {
     ...
     * @return
     */
    @GetMapping("/getUserSectionInfoByToken") public Result<?> getUserSectionInfoByToken(HttpServletRequest request,
     ...
     * @return
     */
    @GetMapping("/appUserList") public Result<?> appUserList(
     ...
     * @return
     */
    @PostMapping(value = "/putRecycleBin") public Result putRecycleBin(@RequestBody JSONObject jsonObject,
     ...
     *
     * @param userIds
     *     被删除的用户ID，多个id用半角逗号分割
     * @return
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteRecycleBin") public Result deleteRecycleBin(@RequestParam("userIds") String userIds) {
        if (StringUtils.isNotBlank(userIds)) {
     ...
     * @return
     */
    @PostMapping(value = "/appEdit") public Result<SysUser> appEdit(HttpServletRequest request,
        @RequestBody JSONObject jsonObject) {
        Result<SysUser> result = new Result<>();
        try {
     ...
     * @return
     */
    @GetMapping(value = "/saveClientId") public Result<SysUser> saveClientId(HttpServletRequest request,
     ...
     * @return Result
     */
    @GetMapping("/queryChildrenByUsername") public Result queryChildrenByUsername(
     ...
     * @return
     */
    @GetMapping("/appQueryByDepartId") public Result<List<SysUser>> appQueryByDepartId(
        @RequestParam(name = "departId", required = false) String departId) {
        Result<List<SysUser>> result = new Result<>();
        List<String> list = new ArrayList<>();
        list.add(departId);
     ...
     * @return
     */
    @GetMapping("/appQueryUser") public Result<List<SysUser>> appQueryUser(
        @RequestParam(name = "keyword", required = false) String keyword) {
        Result<List<SysUser>> result = new Result<>();
     ...
     * @return
     */
    @PostMapping(value = "/updateMobile") public Result<?> changMobile(@RequestBody JSONObject json,
        HttpServletRequest request) {
    ...
    @GetMapping(value = "/validateSso")
    public Result<Boolean> validateSso(@RequestParam(name = "loginid", required = false) String loginid,
        @RequestParam(name = "oaId", required = false) String oaId) {
        if (loginid == null && oaId == null) {
        ...
        if (loginid != null) {
            if (!loginid.equals(sysUser.getLoginid())) {
                return Result.OK(false);
            }
        }

        if (oaId != null) {
            if (!oaId.equals(sysUser.getOaId())) {
                return Result.OK(false);
            }
        }
