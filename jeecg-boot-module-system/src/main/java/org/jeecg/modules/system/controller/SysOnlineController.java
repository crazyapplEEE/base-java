 ...
 * @Version: V1.0
 */
@RestController @RequestMapping("/sys/online") @Slf4j public class SysOnlineController {

    @Autowired public RedisTemplate redisTemplate;
    @Autowired public ISysUserService userService;
    ...
    public Result<Page<SysOnlineVO>> list(@RequestParam(name = "username", required = false) String username,
        ...
        Page<SysOnlineVO> page = new Page<>(pageNo, pageSize);
        ...
        Result<Page<SysOnlineVO>> result = new Result<>();
     ...
     * 强退用户
     */
    @PostMapping(value = "/forceLogout") public Result<Object> forceLogout(@RequestBody SysOnlineVO online) {
        //用户退出逻辑
        ...
        if (sysUser != null) {
            baseCommonService
                .addLog("强制: " + sysUser.getRealname() + "退出成功！", CommonConstant.LOG_TYPE_1, null, sysUser);
