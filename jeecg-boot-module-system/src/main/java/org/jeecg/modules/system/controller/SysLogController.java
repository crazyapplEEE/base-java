 ...
 * @since 2018-12-26
 */
@RestController @RequestMapping("/sys/log") @Slf4j public class SysLogController {
     ...
     * @功能：查询日志记录
     */
    @GetMapping(value = "/list") public Result<IPage<SysLog>> queryPageList(SysLog syslog,
     ...
     * @功能：删除单个日志记录
     */
    @PostMapping(value = "/delete") public Result<SysLog> delete(@RequestParam(name = "id") String id) {
