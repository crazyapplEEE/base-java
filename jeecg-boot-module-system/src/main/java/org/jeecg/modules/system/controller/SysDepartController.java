 ...
 */
@RestController @RequestMapping("/sys/sysDepart") @Slf4j public class SysDepartController {
     ...
     * @return
     */
    @GetMapping(value = "/queryMyDeptTreeList")
     ...
     * @return
     */
    @GetMapping(value = "/queryTreeList") public Result<List<SysDepartTreeModel>> queryTreeList() {
        Result<List<SysDepartTreeModel>> result = new Result<>();
        try {
            // 从内存中读取
     ...
     * @return
     */
    @GetMapping(value = "/queryDepartTreeSync") public Result<List<SysDepartTreeModel>> queryDepartTreeSync(
     ...
     */
    @GetMapping("/queryAllParentId") public Result queryParentIds(
     ...
     * @return
     */
    @GetMapping(value = "/queryIdTree") public Result<List<DepartIdModel>> queryIdTree() {
     ...
     * @return
     */
    @GetMapping(value = "/searchBy") public Result<List<SysDepartTreeModel>> searchBy(
     ...
     * @param request
     */
    @RequestMapping(value = "/exportXls") public ModelAndView exportXls(SysDepart sysDepart,
        ...
        Collections.sort(pageList, new Comparator<SysDepart>() {
            @Override public int compare(SysDepart arg0, SysDepart arg1) {
     ...
     * @return
     */
    @GetMapping("listAll") public Result<List<SysDepart>> listAll(
     ...
     * @return
     */
    @GetMapping(value = "/queryTreeByKeyWord") public Result<Map<String, Object>> queryTreeByKeyWord(
     ...
     * @return
     */
    @GetMapping("/getDepartName") public Result<SysDepart> getDepartName(
     ...
     * @return
     */
    @GetMapping("/getUsersByDepartId") public Result<List<SysUser>> getUsersByDepartId(
