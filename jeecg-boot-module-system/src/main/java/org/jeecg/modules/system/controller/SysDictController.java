 ...
 * @since 2018-12-28
 */
@RestController @RequestMapping("/sys/dict") @Slf4j public class SysDictController {

    @Autowired public RedisTemplate<String, Object> redisTemplate;
    ...
    @GetMapping(value = "/list") public Result<IPage<SysDict>> queryPageList(SysDict sysDict,
     ...
     * @功能：获取树形字典数据
     */
    @SuppressWarnings("unchecked") @GetMapping(value = "/treeList") public Result<List<SysDictTree>> treeList(
     ...
     * @return
     */
    @GetMapping(value = "/getDictItems/{dictCode}") public Result<List<DictModel>> getDictItems(
        @PathVariable String dictCode, @RequestParam(value = "sign", required = false) String sign,
     ...
     * @return
     */
    @GetMapping(value = "/queryAllDictItems") public Result<?> queryAllDictItems(HttpServletRequest request) {
     ...
     * @return
     */
    @GetMapping(value = "/getDictText/{dictCode}/{key}") public Result<String> getDictText(
        @PathVariable("dictCode") String dictCode, @PathVariable("key") String key) {
        log.info(" dictCode : " + dictCode);
     ...
     * @return
     */
    @GetMapping(value = "/loadDict/{dictCode}") public Result<List<DictModel>> loadDict(@PathVariable String dictCode,
     ...
     * @return
     */
    @GetMapping(value = "/loadDictOrderByValue/{dictCode}") public Result<List<DictModel>> loadDictOrderByValue(
        @PathVariable String dictCode, @RequestParam(name = "keyword") String keyword,
     ...
     * @return
     */
    @GetMapping(value = "/loadDictItem/{dictCode}") public Result<List<String>> loadDictItem(
        @PathVariable String dictCode, @RequestParam(name = "key") String keys,
        @RequestParam(value = "sign", required = false) String sign,
        ...
        try {
            if (dictCode.indexOf(",") != -1) {
                ...
                List<String> texts =
                    sysDictService.queryTableDictByKeys(params[0], params[1], params[2], keys, delNotExist);
     ...
     */
    @SuppressWarnings("unchecked") @GetMapping(value = "/loadTreeData")
    public Result<List<TreeSelectModel>> loadTreeData(@RequestParam(name = "pid") String pid,
        ...
        @RequestParam(name = "hasChildField") String hasChildField, @RequestParam(name = "condition") String condition,
        ...
        List<TreeSelectModel> ls =
            sysDictService.queryTreeList(query, tbname, text, code, pidField, pid, hasChildField);
        result.setSuccess(true);
        result.setResult(ls);
        return result;
    }
     ...
     * @return
     */
    @Deprecated @GetMapping("/queryTableData") public Result<List<DictModel>> queryTableData(DictQuery query,
        @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/add") public Result<SysDict> add(@RequestBody SysDict sysDict) {
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/edit") public Result<SysDict> edit(@RequestBody SysDict sysDict) {
        Result<SysDict> result = new Result<>();
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/delete") @CacheEvict(value = CacheConstant.SYS_DICT_CACHE, allEntries = true)
     ...
     */
    //@RequiresRoles({"admin"})
    @PostMapping(value = "/deleteBatch") @CacheEvict(value = CacheConstant.SYS_DICT_CACHE, allEntries = true)
     ...
     * @功能：刷新缓存
     */
    @RequestMapping(value = "/refleshCache") public Result<?> refleshCache() {
     ...
     * @param request
     */
    @RequestMapping(value = "/exportXls") public ModelAndView exportXls(SysDict sysDict, HttpServletRequest request) {
        // Step.1 组装查询条件
     ...
     * @return
     */
    @GetMapping(value = "/deleteList") public Result<List<SysDict>> deleteList() {
     ...
     * @return
     */
    @PostMapping(value = "/deletePhysic/{id}") public Result<?> deletePhysic(@PathVariable String id) {
        try {
     ...
     * @return
     */
    @PostMapping(value = "/back/{id}") public Result<?> back(@PathVariable String id) {
        try {
