...
@RestController @RequestMapping("/sys/dataLog") @Slf4j public class SysDataLogController {
    @Autowired private ISysDataLogService service;

    @GetMapping(value = "/list") public Result<IPage<SysDataLog>> queryPageList(SysDataLog dataLog,
     ...
     * @return
     */
    @GetMapping(value = "/queryCompareList") public Result<List<SysDataLog>> queryCompareList(HttpServletRequest req) {
     ...
     * @return
     */
    @GetMapping(value = "/queryDataVerList") public Result<List<SysDataLog>> queryDataVerList(HttpServletRequest req) {
        Result<List<SysDataLog>> result = new Result<>();
