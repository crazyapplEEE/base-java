...
public class CategoryCodeRule implements IFillRuleHandler {
    ...
    @Override public Object execute(JSONObject params, JSONObject formData) {
         ...
         * */
        //找同类 确定上一个最大的code值
        LambdaQueryWrapper<SysCategory> query =
            new LambdaQueryWrapper<SysCategory>().eq(SysCategory::getPid, categoryPid).isNotNull(SysCategory::getCode)
