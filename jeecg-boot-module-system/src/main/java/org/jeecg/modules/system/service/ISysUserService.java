...
public interface ISysUserService extends IService<SysUser> {
     ...
     * @return
     */
    IPage<SysUser> getUserByDepartIdAndQueryWrapper(Page<SysUser> page, String departId,
     ...
     * 更新手机号、邮箱空字符串为 null
     */
    @Transactional(rollbackFor = Exception.class) boolean updateNullPhoneEmail();
    ...
    SysUser addUserWithPhone(String phone);
}
