 ...
 * @date 2023-05-19
 */
@Data @TableName("zy_regulation_bjmoa_dept") @Accessors(chain = true) @EqualsAndHashCode(callSuper = false)
@ApiModel(value = "zy_regulation_bjmoa_dept对象", description = "轨道运营制度主责部门")
public class ZyRegulationBjmoaDept extends JeecgEntity {
