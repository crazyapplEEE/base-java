...
public class BaseMap extends HashMap<String, Object> {
    ...
    @Override public BaseMap put(String key, Object value) {
    ...
    @SuppressWarnings("unchecked") public Boolean getBoolean(String key) {
        Object obj = super.get(key);
        if (ObjectUtil.isNotEmpty(obj)) {
    ...
    @SuppressWarnings("unchecked") public <T> T get(String key, T def) {
        Object obj = super.get(key);
