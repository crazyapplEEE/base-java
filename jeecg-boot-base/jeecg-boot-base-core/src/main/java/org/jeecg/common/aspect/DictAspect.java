 ...
 * @Version: 1.0
 */
@Aspect @Component @Slf4j public class DictAspect {

    @Autowired public RedisTemplate redisTemplate;
    @Autowired private CommonAPI commonAPI;

    // 定义切点Pointcut
    @Pointcut("execution(public * org.jeecg.modules..*.*Controller.*(..))") public void excudeService() {
    }

    @Around("excudeService()") public Object doAround(ProceedingJoinPoint pjp) throws Throwable {
