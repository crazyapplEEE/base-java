 ...
 * @Date 2018年1月14日
 */
@Aspect @Component public class AutoLogAspect {

    @Resource private BaseCommonService baseCommonService;

    @Pointcut("@annotation(org.jeecg.common.aspect.annotation.AutoLog)") public void logPointCut() {
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time, Object obj) {
        ...
        if (sysUser != null) {
            dto.setUserid(sysUser.getMpUserId());
            dto.setUsername(String.valueOf(sysUser.getOaId()));
            dto.setCreateBy(sysUser.getRealname());
        }
        //耗时
        dto.setCostTime(time);
        dto.setCreateTime(DateUtils.getCurrentDateTimeInBeijing());
        //保存系统日志
    ...
    private String getReqestParams(HttpServletRequest request, JoinPoint joinPoint) {
        ...
        if ("POST".equals(httpMethod) || "PUT".equals(httpMethod) || "PATCH".equals(httpMethod)) {
            ...
            PropertyFilter profilter = new PropertyFilter() {
                @Override public boolean apply(Object o, String name, Object value) {
            ...
            for (int i = 0; i < arguments.length; ++i) {
                if (arguments[i] instanceof MultipartFile[] || arguments[i] instanceof MultipartFile) {
