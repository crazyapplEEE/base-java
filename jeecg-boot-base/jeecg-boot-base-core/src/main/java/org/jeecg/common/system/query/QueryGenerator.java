...
@Slf4j public class QueryGenerator {
     ...
     */
    public static void installMplus(QueryWrapper<?> queryWrapper, Object searchObj,
        ...
        for (int i = 0; i < origDescriptors.length; i++) {
            ...
            try {
                ...
                if (null != value && value.toString().startsWith(COMMA) && value.toString().endsWith(COMMA)) {
                    ...
                    //if( (rule==null || QueryRuleEnum.EQ.equals(rule)) && "class String".equals(type)) {
                    // 可以设置左右模糊或全模糊，因人而异
    ...
    public static void doSuperQuery(QueryWrapper<?> queryWrapper, Map<String, String[]> parameterMap,
        ...
        if (parameterMap != null && parameterMap.containsKey(SUPER_QUERY_PARAMS)) {
            ...
            String superQueryMatchType =
                parameterMap.get(SUPER_QUERY_MATCH_TYPE) != null ? parameterMap.get(SUPER_QUERY_MATCH_TYPE)[0] :
    ...
    private static boolean judgedIsUselessField(String name) {
        return "class".equals(name) || "ids".equals(name) || "page".equals(name) || "rows".equals(name) || "sort"
     ...
     * @return
     */
    @SuppressWarnings({"unchecked", "rawtypes"}) public static String installAuthJdbc(Class<?> clazz) {
    ...
    private static String specialStrConvert(String value) {
        if (DataBaseConstant.DB_TYPE_MYSQL.equals(getDbType()) || DataBaseConstant.DB_TYPE_MARIADB
            .equals(getDbType())) {
