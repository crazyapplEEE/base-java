...
@Configuration public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    @Value("${jeecg.path.webapp}") private String webAppPath;
    @Value("${spring.resource.static-locations}") private String staticLocations;
    ...
    @Bean @Conditional(CorsFilterCondition.class) public CorsFilter corsFilter() {
     ...
     */
    @Bean public InMemoryHttpTraceRepository getInMemoryHttpTrace() {
