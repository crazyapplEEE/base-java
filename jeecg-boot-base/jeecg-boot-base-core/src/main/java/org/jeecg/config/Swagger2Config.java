 ...
 * @Author scott
 */
@Configuration @EnableSwagger2WebMvc @EnableKnife4j @Import(BeanValidatorPluginsConfiguration.class)
public class Swagger2Config implements WebMvcConfigurer {
    ...
    private List<Parameter> setHeaderToken() {
        ...
        tokenPar.name(CommonConstant.X_ACCESS_TOKEN).description("token").modelRef(new ModelRef("string"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            // 大标题
            .title(applicationCnName + "后台服务API接口文档")
            // 版本号
            .version("1.0")
            ...
            .description("后台API接口")
            // 作者
            .contact(new Contact("京投-信息数据管理部", "", "")).license("The Apache License, Version 2.0")
