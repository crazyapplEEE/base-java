 ...
 * @Version:1.0
 */
@Slf4j @Service public class AutoPoiDictConfig implements AutoPoiDictServiceI {
     ...
     * @since：2019-04-09
     */
    @Override public String[] queryDict(String dicTable, String dicCode, String dicText) {
