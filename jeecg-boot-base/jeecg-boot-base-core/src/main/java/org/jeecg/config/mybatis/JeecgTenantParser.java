...
public class JeecgTenantParser extends TenantSqlParser {
     ...
     * @return
     */
    @Override protected Expression builderExpression(Expression currentExpression, Table table) {
    ...
    @Override protected void processPlainSelect(PlainSelect plainSelect, boolean addColumn) {
            ...
            if (!this.getTenantHandler().doTableFilter(fromTable.getName())) {
                ...
                if (addColumn) {
                    plainSelect.getSelectItems()
                        .add(new SelectExpressionItem(new Column(this.getTenantHandler().getTenantIdColumn())));
                }
            }
        } else {
