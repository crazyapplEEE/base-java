...
@Slf4j @Configuration public class ShiroConfig {
    @Resource LettuceConnectionFactory lettuceConnectionFactory;
    @Value("${jeecg.shiro.excludeUrls}") private String excludeUrls;
    @Autowired private Environment env;

    @Bean public static LifecycleBeanPostProcessor lifecycleBeanPostProcessor() {
     ...
     */
    @Bean("shiroFilterFactoryBean") public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
    ...
    @Bean("securityManager") public DefaultWebSecurityManager securityManager(ShiroRealm myRealm) {
     ...
     * @return
     */
    @Bean public IRedisManager redisManager() {
        ...
        if (lettuceConnectionFactory.getClusterConfiguration() == null || lettuceConnectionFactory
            ...
            if (oConvertUtils.isNotEmpty(lettuceConnectionFactory.getPassword())) {
                JedisCluster jedisCluster =
                    new JedisCluster(portSet, 2000, 2000, 5, lettuceConnectionFactory.getPassword(),
