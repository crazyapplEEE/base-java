...
public class DocInfo implements java.io.Serializable {
    ...
    static {
        TYPE_DESC.setXmlType(new javax.xml.namespace.QName("http://webservices.docs.weaver", "DocInfo"));
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://localhost/services/CustomDocService", "int"));
        TYPE_DESC.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://localhost/services/CustomDocService", "string"));
        TYPE_DESC.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
    ...
    private org.jeecg.modules.oa.webservices.soap.customDoc.DocCustomField[] doccustomfields;
    ...
    private org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] pictures;
    ...
    public DocInfo(Integer accessorycount, String allParentName, Integer assetid,
        org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] attachments, int[] childdoc,
        String[] chiledocname, Integer crmid, String docCode, Integer docEdition, Integer docEditionId,
        String docEditionStr, Integer docPublishType, Integer docStatus, String docStatusStr, String docSubject,
        Integer docType, String docapprovedate, String docapprovetime, Integer docapproveuserid,
        String docapproveusername, Integer docapproveusertype, String docarchivedate, String docarchivetime,
        Integer docarchiveuserid, String docarchiveusername, Integer docarchiveusertype, String doccanceldate,
        String doccanceltime, Integer doccanceluserid, String doccancelusername, Integer doccancelusertype,
        String doccontent, String doccreatedate, Integer doccreaterid, String doccreatername, Integer doccreatertype,
        String doccreatetime, org.jeecg.modules.oa.webservices.soap.customDoc.DocCustomField[] doccustomfields,
        String docdepartmentStr, Integer docdepartmentid, String docinvaldate, String docinvaltime,
        Integer docinvaluserid, String docinvalusername, Integer docinvalusertype, Integer doclangurage,
        String doclangurageStr, String doclastmoddate, String doclastmodtime, Integer doclastmoduserid,
        String doclastmodusername, Integer doclastmodusertype, int[] dummyIds, String[] dummyNames, Integer financeid,
        Integer hrmresid, Integer id, Integer imagefileId, String invalidationdate, String isreply, Integer itemid,
        String keyword, Integer maincategory, String maincategoryStr, Integer maindoc, String maindocname,
        Integer ownerid, String ownername, Integer ownertype, String parentids,
        org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] pictures, Integer projectid, String publishable,
        Integer replaydoccount, Integer replydocid, Integer seccategory, String seccategoryStr, Integer subcategory,
        String subcategoryStr, Integer versionId) {
     ...
     * @return attachments
     */
    public org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] getAttachments() {
        return attachments;
    }
     ...
     * @param attachments
     */
    public void setAttachments(org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] attachments) {
        this.attachments = attachments;
    }
     ...
     */
    public org.jeecg.modules.oa.webservices.soap.customDoc.DocCustomField[] getDoccustomfields() {
        return doccustomfields;
    }
     ...
     */
    public void setDoccustomfields(org.jeecg.modules.oa.webservices.soap.customDoc.DocCustomField[] doccustomfields) {
        this.doccustomfields = doccustomfields;
    }
     ...
     * @return pictures
     */
    public org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] getPictures() {
        return pictures;
    }
     ...
     * @param pictures
     */
    public void setPictures(org.jeecg.modules.oa.webservices.soap.customDoc.DocAttachment[] pictures) {
        this.pictures = pictures;
    }
    ...
    @Override public synchronized boolean equals(Object obj) {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = ((this.accessorycount == null && other.getAccessorycount() == null) || (this.accessorycount != null
            && this.accessorycount.equals(other.getAccessorycount()))) && (
            (this.allParentName == null && other.getAllParentName() == null) || (this.allParentName != null
                && this.allParentName.equals(other.getAllParentName()))) && (
            (this.assetid == null && other.getAssetid() == null) || (this.assetid != null && this.assetid.equals(
                other.getAssetid()))) && ((this.attachments == null && other.getAttachments() == null) || (
            this.attachments != null && java.util.Arrays.equals(this.attachments, other.getAttachments()))) && (
            (this.childdoc == null && other.getChilddoc() == null) || (this.childdoc != null && java.util.Arrays.equals(
                this.childdoc, other.getChilddoc()))) && ((this.chiledocname == null && other.getChiledocname() == null)
            || (this.chiledocname != null && java.util.Arrays.equals(this.chiledocname, other.getChiledocname()))) && (
            (this.crmid == null && other.getCrmid() == null) || (this.crmid != null && this.crmid.equals(
                other.getCrmid()))) && ((this.docCode == null && other.getDocCode() == null) || (this.docCode != null
            && this.docCode.equals(other.getDocCode()))) && ((this.docEdition == null && other.getDocEdition() == null)
            || (this.docEdition != null && this.docEdition.equals(other.getDocEdition()))) && (
            (this.docEditionId == null && other.getDocEditionId() == null) || (this.docEditionId != null
                && this.docEditionId.equals(other.getDocEditionId()))) && (
            (this.docEditionStr == null && other.getDocEditionStr() == null) || (this.docEditionStr != null
                && this.docEditionStr.equals(other.getDocEditionStr()))) && (
            (this.docPublishType == null && other.getDocPublishType() == null) || (this.docPublishType != null
                && this.docPublishType.equals(other.getDocPublishType()))) && (
            (this.docStatus == null && other.getDocStatus() == null) || (this.docStatus != null
                && this.docStatus.equals(other.getDocStatus()))) && (
            (this.docStatusStr == null && other.getDocStatusStr() == null) || (this.docStatusStr != null
                && this.docStatusStr.equals(other.getDocStatusStr()))) && (
            (this.docSubject == null && other.getDocSubject() == null) || (this.docSubject != null
                && this.docSubject.equals(other.getDocSubject()))) && (
            (this.docType == null && other.getDocType() == null) || (this.docType != null && this.docType.equals(
                other.getDocType()))) && ((this.docapprovedate == null && other.getDocapprovedate() == null) || (
            this.docapprovedate != null && this.docapprovedate.equals(other.getDocapprovedate()))) && (
            (this.docapprovetime == null && other.getDocapprovetime() == null) || (this.docapprovetime != null
                && this.docapprovetime.equals(other.getDocapprovetime()))) && (
            (this.docapproveuserid == null && other.getDocapproveuserid() == null) || (this.docapproveuserid != null
                && this.docapproveuserid.equals(other.getDocapproveuserid()))) && (
            (this.docapproveusername == null && other.getDocapproveusername() == null) || (
                this.docapproveusername != null && this.docapproveusername.equals(other.getDocapproveusername()))) && (
            (this.docapproveusertype == null && other.getDocapproveusertype() == null) || (
                this.docapproveusertype != null && this.docapproveusertype.equals(other.getDocapproveusertype()))) && (
            (this.docarchivedate == null && other.getDocarchivedate() == null) || (this.docarchivedate != null
                && this.docarchivedate.equals(other.getDocarchivedate()))) && (
            (this.docarchivetime == null && other.getDocarchivetime() == null) || (this.docarchivetime != null
                && this.docarchivetime.equals(other.getDocarchivetime()))) && (
            (this.docarchiveuserid == null && other.getDocarchiveuserid() == null) || (this.docarchiveuserid != null
                && this.docarchiveuserid.equals(other.getDocarchiveuserid()))) && (
            (this.docarchiveusername == null && other.getDocarchiveusername() == null) || (
                this.docarchiveusername != null && this.docarchiveusername.equals(other.getDocarchiveusername()))) && (
            (this.docarchiveusertype == null && other.getDocarchiveusertype() == null) || (
                this.docarchiveusertype != null && this.docarchiveusertype.equals(other.getDocarchiveusertype()))) && (
            (this.doccanceldate == null && other.getDoccanceldate() == null) || (this.doccanceldate != null
                && this.doccanceldate.equals(other.getDoccanceldate()))) && (
            (this.doccanceltime == null && other.getDoccanceltime() == null) || (this.doccanceltime != null
                && this.doccanceltime.equals(other.getDoccanceltime()))) && (
            (this.doccanceluserid == null && other.getDoccanceluserid() == null) || (this.doccanceluserid != null
                && this.doccanceluserid.equals(other.getDoccanceluserid()))) && (
            (this.doccancelusername == null && other.getDoccancelusername() == null) || (this.doccancelusername != null
                && this.doccancelusername.equals(other.getDoccancelusername()))) && (
            (this.doccancelusertype == null && other.getDoccancelusertype() == null) || (this.doccancelusertype != null
                && this.doccancelusertype.equals(other.getDoccancelusertype()))) && (
            (this.doccontent == null && other.getDoccontent() == null) || (this.doccontent != null
                && this.doccontent.equals(other.getDoccontent()))) && (
            (this.doccreatedate == null && other.getDoccreatedate() == null) || (this.doccreatedate != null
                && this.doccreatedate.equals(other.getDoccreatedate()))) && (
            (this.doccreaterid == null && other.getDoccreaterid() == null) || (this.doccreaterid != null
                && this.doccreaterid.equals(other.getDoccreaterid()))) && (
            (this.doccreatername == null && other.getDoccreatername() == null) || (this.doccreatername != null
                && this.doccreatername.equals(other.getDoccreatername()))) && (
            (this.doccreatertype == null && other.getDoccreatertype() == null) || (this.doccreatertype != null
                && this.doccreatertype.equals(other.getDoccreatertype()))) && (
            (this.doccreatetime == null && other.getDoccreatetime() == null) || (this.doccreatetime != null
                && this.doccreatetime.equals(other.getDoccreatetime()))) && (
            (this.doccustomfields == null && other.getDoccustomfields() == null) || (this.doccustomfields != null
                && java.util.Arrays.equals(this.doccustomfields, other.getDoccustomfields()))) && (
            (this.docdepartmentStr == null && other.getDocdepartmentStr() == null) || (this.docdepartmentStr != null
                && this.docdepartmentStr.equals(other.getDocdepartmentStr()))) && (
            (this.docdepartmentid == null && other.getDocdepartmentid() == null) || (this.docdepartmentid != null
                && this.docdepartmentid.equals(other.getDocdepartmentid()))) && (
            (this.docinvaldate == null && other.getDocinvaldate() == null) || (this.docinvaldate != null
                && this.docinvaldate.equals(other.getDocinvaldate()))) && (
            (this.docinvaltime == null && other.getDocinvaltime() == null) || (this.docinvaltime != null
                && this.docinvaltime.equals(other.getDocinvaltime()))) && (
            (this.docinvaluserid == null && other.getDocinvaluserid() == null) || (this.docinvaluserid != null
                && this.docinvaluserid.equals(other.getDocinvaluserid()))) && (
            (this.docinvalusername == null && other.getDocinvalusername() == null) || (this.docinvalusername != null
                && this.docinvalusername.equals(other.getDocinvalusername()))) && (
            (this.docinvalusertype == null && other.getDocinvalusertype() == null) || (this.docinvalusertype != null
                && this.docinvalusertype.equals(other.getDocinvalusertype()))) && (
            (this.doclangurage == null && other.getDoclangurage() == null) || (this.doclangurage != null
                && this.doclangurage.equals(other.getDoclangurage()))) && (
            (this.doclangurageStr == null && other.getDoclangurageStr() == null) || (this.doclangurageStr != null
                && this.doclangurageStr.equals(other.getDoclangurageStr()))) && (
            (this.doclastmoddate == null && other.getDoclastmoddate() == null) || (this.doclastmoddate != null
                && this.doclastmoddate.equals(other.getDoclastmoddate()))) && (
            (this.doclastmodtime == null && other.getDoclastmodtime() == null) || (this.doclastmodtime != null
                && this.doclastmodtime.equals(other.getDoclastmodtime()))) && (
            (this.doclastmoduserid == null && other.getDoclastmoduserid() == null) || (this.doclastmoduserid != null
                && this.doclastmoduserid.equals(other.getDoclastmoduserid()))) && (
            (this.doclastmodusername == null && other.getDoclastmodusername() == null) || (
                this.doclastmodusername != null && this.doclastmodusername.equals(other.getDoclastmodusername()))) && (
            (this.doclastmodusertype == null && other.getDoclastmodusertype() == null) || (
                this.doclastmodusertype != null && this.doclastmodusertype.equals(other.getDoclastmodusertype()))) && (
            (this.dummyIds == null && other.getDummyIds() == null) || (this.dummyIds != null && java.util.Arrays.equals(
                this.dummyIds, other.getDummyIds()))) && ((this.dummyNames == null && other.getDummyNames() == null)
            || (this.dummyNames != null && java.util.Arrays.equals(this.dummyNames, other.getDummyNames()))) && (
            (this.financeid == null && other.getFinanceid() == null) || (this.financeid != null
                && this.financeid.equals(other.getFinanceid()))) && (
            (this.hrmresid == null && other.getHrmresid() == null) || (this.hrmresid != null && this.hrmresid.equals(
                other.getHrmresid()))) && ((this.id == null && other.getId() == null) || (this.id != null
            && this.id.equals(other.getId()))) && ((this.imagefileId == null && other.getImagefileId() == null) || (
            this.imagefileId != null && this.imagefileId.equals(other.getImagefileId()))) && (
            (this.invalidationdate == null && other.getInvalidationdate() == null) || (this.invalidationdate != null
                && this.invalidationdate.equals(other.getInvalidationdate()))) && (
            (this.isreply == null && other.getIsreply() == null) || (this.isreply != null && this.isreply.equals(
                other.getIsreply()))) && ((this.itemid == null && other.getItemid() == null) || (this.itemid != null
            && this.itemid.equals(other.getItemid()))) && ((this.keyword == null && other.getKeyword() == null) || (
            this.keyword != null && this.keyword.equals(other.getKeyword()))) && (
            (this.maincategory == null && other.getMaincategory() == null) || (this.maincategory != null
                && this.maincategory.equals(other.getMaincategory()))) && (
            (this.maincategoryStr == null && other.getMaincategoryStr() == null) || (this.maincategoryStr != null
                && this.maincategoryStr.equals(other.getMaincategoryStr()))) && (
            (this.maindoc == null && other.getMaindoc() == null) || (this.maindoc != null && this.maindoc.equals(
                other.getMaindoc()))) && ((this.maindocname == null && other.getMaindocname() == null) || (
            this.maindocname != null && this.maindocname.equals(other.getMaindocname()))) && (
            (this.ownerid == null && other.getOwnerid() == null) || (this.ownerid != null && this.ownerid.equals(
                other.getOwnerid()))) && ((this.ownername == null && other.getOwnername() == null) || (
            this.ownername != null && this.ownername.equals(other.getOwnername()))) && (
            (this.ownertype == null && other.getOwnertype() == null) || (this.ownertype != null
                && this.ownertype.equals(other.getOwnertype()))) && (
            (this.parentids == null && other.getParentids() == null) || (this.parentids != null
                && this.parentids.equals(other.getParentids()))) && (
            (this.pictures == null && other.getPictures() == null) || (this.pictures != null && java.util.Arrays.equals(
                this.pictures, other.getPictures()))) && ((this.projectid == null && other.getProjectid() == null) || (
            this.projectid != null && this.projectid.equals(other.getProjectid()))) && (
            (this.publishable == null && other.getPublishable() == null) || (this.publishable != null
                && this.publishable.equals(other.getPublishable()))) && (
            (this.replaydoccount == null && other.getReplaydoccount() == null) || (this.replaydoccount != null
                && this.replaydoccount.equals(other.getReplaydoccount()))) && (
            (this.replydocid == null && other.getReplydocid() == null) || (this.replydocid != null
                && this.replydocid.equals(other.getReplydocid()))) && (
            (this.seccategory == null && other.getSeccategory() == null) || (this.seccategory != null
                && this.seccategory.equals(other.getSeccategory()))) && (
            (this.seccategoryStr == null && other.getSeccategoryStr() == null) || (this.seccategoryStr != null
                && this.seccategoryStr.equals(other.getSeccategoryStr()))) && (
            (this.subcategory == null && other.getSubcategory() == null) || (this.subcategory != null
                && this.subcategory.equals(other.getSubcategory()))) && (
            (this.subcategoryStr == null && other.getSubcategoryStr() == null) || (this.subcategoryStr != null
                && this.subcategoryStr.equals(other.getSubcategoryStr()))) && (
            (this.versionId == null && other.getVersionId() == null) || (this.versionId != null
    ...
    @Override public synchronized int hashCode() {
        ...
        if (getChilddoc() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getChilddoc()); i++) {
        ...
        if (getChiledocname() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getChiledocname()); i++) {
        ...
        if (getDoccustomfields() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getDoccustomfields()); i++) {
        ...
        if (getDummyIds() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getDummyIds()); i++) {
        ...
        if (getDummyNames() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getDummyNames()); i++) {
        ...
        if (getPictures() != null) {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getPictures()); i++) {
